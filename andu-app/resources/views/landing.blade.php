...
@media (max-width: 480px) {
    .ImagesContainer {
        height: 40%; /* Adjust the height for very small screens */
    }
    ...
    .OptionUn, .OptionDeux, .OptionTrois {
...
>>>>>>> 80dc62212ed7b84b8558f6c826ea00a6e3dd6573
                </div>
            </div>
        </div>
    </div>
